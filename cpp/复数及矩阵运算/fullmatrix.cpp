...
void CFullMatrix::Wipe() // fills up a square matrix with zeros in every entry
{
  for (int i = 0; i < n; i++)
  {
    b[i] = 0;
...
{
  // solves the linear system m x = b for x.
...
void CComplexFullMatrix::Wipe() // fills up a square matrix with zeros in every entry
{
  for (int i = 0; i < n; i++)
  {
    b[i] = 0;
